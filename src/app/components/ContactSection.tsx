    ...
    <section className="py-24 md:py-32 relative overflow-hidden bg-background border-t border-hairline" id="contact">
      ...
      <div className="max-w-3xl mx-auto px-6 md:px-8">
        ...
        <motion.div
          ...
          transition={{ duration: 0.4 }}
          viewport={{ once: true }}
          className="glass-card rounded-xl p-5 sm:p-6 md:p-8 border border-hairline bg-surface text-center space-y-6 sm:space-y-8"
        >
          {/* Status Eyebrow info */}
          <div className="flex flex-wrap items-center justify-center gap-4 border-b border-hairline pb-4 sm:pb-6 text-[10px] font-mono text-text-muted">
          ...
          <div className="space-y-4 max-w-lg mx-auto">
            <p className="text-xs sm:text-sm md:text-base text-text-muted leading-relaxed font-sans font-light">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 pt-2">
            <MagneticButton
              ...
              className="flex items-center justify-center h-11 px-6 sm:px-8 w-full sm:w-52 rounded-lg bg-white text-black text-xs font-mono font-semibold tracking-tight hover:bg-zinc-200 active:scale-98 transition-all shadow-md shadow-white/5"
            >
              dispatch_email
            ...
            <a
              ...
              className="flex items-center justify-center h-11 px-6 sm:px-8 w-full sm:w-52 rounded-lg border border-zinc-800 bg-zinc-950/80 text-white text-xs font-mono hover:bg-zinc-900 hover:border-zinc-700 active:scale-98 transition-all cursor-pointer"
            >
              linkedin_profile
            ...
            <div className="space-y-3.5">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <a href="mailto:dakshjain080@gmail.com" className="text-text-primary hover:text-accent transition-colors block text-[11px] sm:text-xs break-all">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <a href="tel:+917627056978" className="text-text-primary hover:text-accent transition-colors block text-[11px] sm:text-xs">
                    +91 7627056978
                  </a>
                </div>
              </div>
            ...
            <div className="space-y-3.5">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <span className="text-text-primary block text-[11px] sm:text-xs">
                    Jaipur, India
                  </span>
                </div>
              </div>
